...
export default function HomePage() {
  ...
  return (
    <main className="bte-landing">
      ...
      <footer className="landing-footer"><a className="landing-brand" href="/"><span className="landing-mark"><i /><i /><i /></span><span><b>Blockchain Trust</b><small>Enterprise Markets</small></span></a><span>Educational platform · Paper workspace · No guaranteed returns</span><span>© 2026 BTE</span></footer>
    </main>
  );
}
