    ...
    <main className="terminal-shell">
      ...
      <section className="workspace">
        ...
        <div className="content-wrap">
          ...
          <footer className="workspace-footer"><span><ShieldCheck size={14} />Secure session · Protected by BTE TrustLayer</span><span>Paper account · Data is simulated · © 2026 Blockchain Trust Enterprise</span></footer>
        </div>
      </section>
