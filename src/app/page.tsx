  ...
  return (
    <main className="terminal-shell">
      ...
      <section className="workspace">
        ...
        {activeNav !== 'Overview' && <FeatureWorkspace area={activeNav as WorkspaceArea} config={platformConfig} onNotify={setNotice} onOpenOrder={() => setTradeOpen(true)} />}<div className="content-wrap overview-content">
